...
import {
  ...
  ,adjWF , positiveActiveColor,
  positiveDisableColor,
  negativeActiveColor,
  negativeDisableColor , tooltip
...
class Collapsable_Table extends React.Component {
  ...
  render() {
    ...
    var { props: { collapsableData , w1 , w2 , w3 , depth , setDepth , selectedDepth} } = this;
                      ...
                      <div className={`flex`} 
                       style = {{
                        ...
                        <p
                          ...
                          style={adjWF(_w1 , 12,0,key=="Total Liabilities"?1:0 , 'pointer')} className={` grayHover `} id={"Colkey" + key} >
                          {key}
                        </p>
                        ...
                        {(() => {
                          ...
                          {
                            return(
                                <p style={adjWF(20 , 12,0,key=="Total Liabilities"?1:0)} align = "right" className={`grayHover`}>
                        ...
                        {(() => {
                          ...
                          {
                            return(
                                <p style={adjWF(_w2 , 12,0,key=="Total Liabilities"?1:0)} align = "right" className={`grayHover`}>
                        ...
                        {(() => {
                          ...
                          if(collapsableData[key]["last"] == 1 || !this.state.opened)
                          {
                            ...
                            return(
                                <p style={adjWF(_w3, 12,0,key=="Total Liabilities"?1:0)} align = "right"  className={`grayHover`}>
                  ...
                  if(key != "opening" && key != "closing" && key != "last")
                  {
                      ...
                      style = {{
                        ...
                        <p
                          ...
                          style={adjWF(_w1 - 30 , 12,0,key=="Total Liabilities"?1:0 , 'pointer') } className={` grayHover `} id={"Colkey" + key} >
                        ...
                        {(() => {
                          ...
                          {
                            return(
                                <p style={adjWF(30 , 12,0,key=="Total Assets"?1:0)} align = "left" className={`grayHover`}>
                                    {(data[key]["number"])}</p>
                              )
                          } else {
                            return(
  ...
  _prepareData = () => {
    ...
    if(queryData["Liability"])
    {
      ...
      data.forEach(item => {
        ...
        if(item["AccountSubType"] == "Current Liability")
        {
            ...
            <Grid container >
              <Grid item md={6} sm={6} xs={6} >
                <div className={`flex`} >
                  ...
                  style={adjWF(w2, 12, 0 , 1 , 'pointer')} align = "right">
                       Opening Balance
                  ...
                  style={adjWF(w3 , 12, 0 , 1,'pointer')} align = "right">
                       Closing Balance 
                       <svg  width={18} height={18} viewBox="0 0 24 24">
