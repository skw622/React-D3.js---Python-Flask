...
import { BarStack, Bar , BarStackHorizontal} from '@vx/shape';
...
import {
  getParams, getMonth, thousandFormat, thousandFormat2 , getIndexFromElementList,getIndexFromObjList,
...
import {
  ...
  activeLabelColor,
  tooltip , axis, thinAxis, barThinHeight , adjWF , ship
...
// cee6f0 ccdce9
  ...
  render() {
    ...
    let keys =  [];
    keys.push("IF12Months");
    keys.push("IFGT12Months");
    ...
    return (
      <div className={classes.root}>
        ...
        <div className="well" style = {{minHeight:'200px',maxHeight:'500px',overflowY: 'auto' }}>
          <div  style={adjWF(width , 12, 0 , 0 , '')}  id="wrapper">
            {data.map((item, i) => {
                const yMax = barThinHeight;
                const _item = [];
                _item.push(item);
                              ...
                              {( barStacks ) => {
                                return barStacks.map(barStack => {
                                  ...
                                  return barStack.bars.map(bar => {
                                    /*if(bar.width < 0)
                                    {
                                      console.log("+_+_+_+_+_+_+_+_+" + xScale(0));
                                      console.log(xScale(-15882) + "," + bar.x , "," +(xScale(0) + bar.width));
                                      console.log(bar.bar);
                                    }*/
                                    return (
                                      <rect
